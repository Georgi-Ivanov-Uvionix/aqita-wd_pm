...
typedef struct UVX_COMM_M2JMB
{
 ...
 typedef enum
 {
    ...
    UVX_M2JMB_BATT_STATE_TIME_1       = 0x48,
    UVX_M2JMB_BATT_STATE_TIME_2       = 0x49,
    UVX_M2JMB_BATT_ERROR              = 0x4A,  
    UVX_M2JMB_BATT_QMAX_PASSED_BQ_1   = 0x4B,  
    UVX_M2JMB_BATT_QMAX_PASSED_BQ_2   = 0x4C,  
    UVX_M2JMB_BATT_QMAX_PASSED_BQ_3   = 0x4D,
    UVX_M2JMB_BATT_STATE_TIME_3        = 0x4E,
